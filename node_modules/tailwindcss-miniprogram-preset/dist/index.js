...
function createRem2rpx(option) {
    const remReplace = createRemReplace(option.rootValue, option.unitPrecision, option.minPixelValue);
    return (str) => {
...
function createExpandThemeConfig(option) {
    const rem2rpx = createRem2rpx(option !== null && option !== void 0 ? option : defaultOptions);
